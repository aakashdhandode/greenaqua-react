        ...
        return (
            <>
                {/* <Form className='details-form-shedo' onSubmit={this.saveStudent}>
                    ...
                    <Form.Group className="mb-3"  >
                        <textarea className="form-control" name="message" onChange={this.handleInput} value={this.state.message} rows="3" placeholder="Enter Message"></textarea>
                    </Form.Group>
                ...
                <Form className='details-form-shedo' onSubmit={this.saveStudent}>
                    ...
                    {/* <h6>Packaged Sewage Treatment Plant</h6> */}
                    <Form.Group>
                        <Form.Control type="text" name="name" onChange={this.handleInput} value={this.state.name} className='input-feild-height' placeholder="Enter Name" />
                    </Form.Group>
                    <Form.Group>
